...
import com.daml.ledger.participant.state.kvutils.{ApiWrapper, InMemoryKVParticipantState}
...
//    Ref.LedgerString.assertFromString("aio"),
//    Some(new File("/Users/gerolf/kvutils.data"))
  )

  val readService = ApiWrapper.V1ToV2Rread(ledger)
  val writeService = ApiWrapper.V1ToV2Write(ledger)
